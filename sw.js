// amber的工作台 Service Worker v14.64
// v14.64: 首页预算卡固定展示当前年份，不跟随预算页年份选择
...
// v14.38: 失败表自动熔断（黑名单机制），避免 schema cache 死锁时反复刷错
// v14.39: 事件分类色块 + 一键按标题批量分类
// v14.40: 暗色模式 + 数据备份导出/导入 + 移除 links 孤儿表
...
// v14.47: 旅行规划列表纯时间排序 + 年份/月份时间轴 + 目的地自动匹配经纬度
...
const VERSION = 'amber-workbench-v14.64';
